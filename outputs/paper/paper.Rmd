...
```{r Q10, echo = FALSE, message = FALSE, fig.cap = "Food Courier Service Restaurants Received the Most Orders From During Study Period", fig.width=5, fig.height=3.5}
...
```{r reveffects, echo = FALSE, message = FALSE, fig.height=5.5, fig.width=5, fig.cap="Changes in Revenue During Intervention Period Compared to the Previous Quarter"}
grid.arrange(q7, q8)
```
...
```{r Q11, fig.height = 3.5, fig.width = 5, echo = FALSE, message = FALSE, fig.cap = "Adjustments Made to Menu Prices During the Intervention Period"}
...
```{r opshourseffects, fig.height=3.5, fig.width=8, echo = FALSE, message = FALSE, fig.cap="Effects on Hours of Operation During Intervention Period by Condition"}
grid.arrange(q12, q13, ncol = 2)
```

```{r opsdayseffects, fig.height=3.5, fig.width=8, echo = FALSE, message = FALSE, fig.cap="Effects on Days of Operation During Intervention Period by Condition"}
