...
# Round values
t_tests[] <- lapply(t_tests, round, 2)
...
q7_chi <- table(all_simulated_dataset$Q7, all_simulated_dataset$type) %>%
  chisq.test()
tableChisq("Pearson's Chi-squared Test for Q7", q7_chi$statistic, q7_chi$parameter, q7_chi$p.value)
```
...
q8_chi <- table(all_simulated_dataset$Q8, all_simulated_dataset$type) %>%
  chisq.test()
tableChisq("Pearson's Chi-squared Test for Q8", q8_chi$statistic, q8_chi$parameter, q8_chi$p.value)
```
...
q10_chi <- table(all_simulated_dataset$Q10, all_simulated_dataset$type) %>%
  chisq.test()
tableChisq("Pearson's Chi-squared Test for Q10", q10_chi$statistic, q10_chi$parameter, q10_chi$p.value)
```
