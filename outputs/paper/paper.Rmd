...
```{r Q5 + Q6 Bar Graphs, echo = FALSE, message = FALSE}
### Prior to (intervention start date), how many people did you employ?
### How many people do you currently employ?

#ggplot(data = treatment_group, mapping = aes(x = Q5)) +
 #  geom_bar() +
  # labs(x = "# of employees",
   #     y = "# of restaurants",
    #    title = "# of employees prior to (date) for treatment group") +
  #theme_minimal()

#ggplot(data = control_group, mapping = aes(x = Q5)) +
 #  geom_bar() +
  # labs(x = "# of employees",
   #     y = "# of restaurants",
    #    title = "# of employees prior to (date) for control group",
     #   group = "Legend") +
  #theme_minimal()


#ggplot(data = treatment_group, mapping = aes(x = Q6)) +
 #  geom_bar() +
  # labs(x = "# of employees",
   #     y = "# of restaurants",
    #    title = "Current # of employees for treatment group") +
  #theme_minimal()

#ggplot(data = control_group, mapping = aes(x = Q6)) +
 #  geom_bar() +
  # labs(x = "# of employees",
   #     y = "# of restaurants",
    #    title = "Current # of employees for control gruop") +
  # theme_minimal() 
