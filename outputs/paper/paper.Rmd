...
Pearson’s Chi-squared test is used to see if there is a statistically significant difference between the intervention and the adjustments of the restaurants. The test results show that the p-values of all adjustments are extremely close to 0, meaning that there is a high correlation between those variables. Consequently, it is expected that restaurants will adjust the menu price and reduce their operating schedule if they operate on a delivery and take-out only basis.
