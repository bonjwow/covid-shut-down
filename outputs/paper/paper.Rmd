...
```{r Q7, echo = FALSE, message = FALSE, fig.cap = "The changes of revenue between Oct 1 and Dec 31"}
...
ggplot(data = all_simulated_dataset, mapping = aes(x = Q7, fill = type)) + 
  ...
  labs(x = "Revenue Change",
       y = "# of Restaurants",
       title = "Revenue changes during the intervention",
       fill = "Condition") +
  theme_fivethirtyeight() + 
  scale_fill_tableau(labels = c("Control", "Intervention"), guide = guide_legend(reverse = TRUE))
...
```{r Q8, echo = FALSE, message = FALSE, fig.cap = "The percentage of total sales revenue decrease between Oct 1 and Dec 31"}
...
ggplot(data = all_simulated_dataset, mapping = aes (x = Q8, fill = type)) +
  ...
  labs(x = "Aprrox. % Decrease in Total Sales Revenue",
       y = "# of Restaurants",
       title = str_wrap("Percentage of total sales revenue decrease during the intervention", 40),
       fill = "Condition") +
  theme_fivethirtyeight() + 
  scale_fill_tableau(labels = c("Control", "Intervention"), guide = guide_legend(reverse = TRUE))
...
```{r Q9, echo = FALSE, message = FALSE, fig.cap = "The total revenue from takeout or delivery prior to Oct 1"}
...
my_title = "Total revenue from takeout/delivery prior to the intervention"
...
```{r Q11, echo = FALSE, message = FALSE, fig.cap = "Price changes on the menu between Oct 1 and Dec 31"}
...
ggplot(data = all_simulated_dataset, mapping = aes (x = Q10, fill = type)) +
  ...
  labs(x = "Adjustments to Menu Prices",
       y = "# of Restaurants",
       title = str_wrap("Price adjustments during the intervention", 30),
       fill = "Condition") +
  scale_fill_tableau(labels = c("Control", "Intervention"), guide = guide_legend(reverse = TRUE)) +
  theme_fivethirtyeight()
```
...
```{r Q12, echo = FALSE, message = FALSE, fig.cap = "Reduced operating hours between Oct 1 and Dec 31"}
...
ggplot(data = all_simulated_dataset, mapping = aes(x = Q12, fill = type)) +
  ...
  labs(x = "Reduction in hours of operation",
       y = "# of restaurants",
       title = str_wrap("Reducton in operating hours during the intervention", 30),
       fill = "Condition") +
  theme_fivethirtyeight() +
  scale_fill_tableau(labels = c("Control", "Intervention"), guide = guide_legend(reverse = TRUE))
```
...
```{r Q13, echo = FALSE, message = FALSE, fig.cap = "The percentage of operating hours reduced between Oct 1 and Dec 31"}
...
ggplot(data = all_simulated_dataset, mapping = aes(x = Q13, fill = type)) +
  ...
  labs(x = "Hours Reduced per Week",
       y = "# of Restaurants",
       title = str_wrap("Percentage of reduced operating hours during the intervention", 30),
       fill = "Condition") +
  scale_fill_tableau(labels = c("Control", "Intervention"), guide = guide_legend(reverse = TRUE)) +
  theme_fivethirtyeight()
```

```{r Q14, echo = FALSE, message = FALSE, fig.cap = "Operating days reduced between Oct 1 and Dec 31"}
...
ggplot(data = all_simulated_dataset, mapping = aes(x = Q14, fill = type)) +
  ...
  labs(x = "Reduction in Days of Operation",
       y = "# of Restaurants",
       title = str_wrap("Operating days reduced during the intervention", 30),
       fill = "Condition") +
  scale_fill_tableau(labels = c("Control", "Intervention"), guide = guide_legend(reverse = TRUE)) +
  theme_fivethirtyeight()
```
...
```{r Q15, echo = FALSE, message = FALSE, fig.cap = "The percentage of operating days reduced between Oct 1 and Dec 31"}
...
ggplot(data = all_simulated_dataset, mapping = aes(x = Q15, fill = type)) +
  ...
  labs(x = "Days Reduced",
       y = "# of Restaurants",
       title = "Percentage of reduced operating days during the intervention",
       fill = "Condition") +
    scale_fill_tableau(labels = c("Control", "Intervention"), guide = guide_legend(reverse = TRUE)) +
  theme_fivethirtyeight()
```

```{r Q16, echo = FALSE, message = FALSE, fig.cap = "Funding applications during the intervention"}
