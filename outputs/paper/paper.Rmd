...
Questions related to the adjustments of the restaurants during the intervention, such as a menu price, and hours and days of operation (Figure \@ref(fig:opseffects)) show us that:
...
q11 <- ggplot(data = all_simulated_dataset, mapping = aes (x = Q10, fill = type)) +
  geom_bar() +  
  coord_flip() + 
...
```{r opseffects, fig.width=11.5, fig.height=10, echo = FALSE, message = FALSE, fig.cap="Effects on hours and days of operation as a result of intervention by condition"}
grid.arrange(q11, q12, q13, q14, q15)
```
